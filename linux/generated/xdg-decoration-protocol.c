...
typedef int mbw_xdg_decoration_protocol_placeholder;

#else
#error "xdg-decoration protocol source placeholder reached a Linux build; install wayland-protocols and rerun the prebuild step"
#endif
