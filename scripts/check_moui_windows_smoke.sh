...
pkg="modules/window/examples/moui_windows_smoke"
main="$pkg/main.mbt"
manifest="$pkg/moon.pkg"
stub="$pkg/input_native.c"
exe="_build/native/debug/build/wzzc-dev/window/examples/moui_windows_smoke/moui_windows_smoke.exe"
...
require_text "$main" "window.native_window_handle()"
